...
class AdminNewPostScreen extends StatelessWidget {
  const AdminNewPostScreen({Key? key}) : super(key: key);
      ...
      builder: (controller) {
        return ConditionalBuilder(
          ...
          builder: (context) => Scaffold(
            appBar: AppBar(
              elevation: 0,
              title: const Text('Add Post',style: TextStyle(fontSize: 20),),
                    ...
                    child: SingleChildScrollView(
                      child: TextFormField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          hintText: 'Tell something to all users ...',
