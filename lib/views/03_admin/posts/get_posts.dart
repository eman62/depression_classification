  ...
  Widget build(BuildContext context) {
    return GetBuilder<AdminController>(
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Posts', style: TextStyle(fontWeight: FontWeight.w700,fontSize: 25),),
          ),
          body: Padding(
            ...
            child: ConditionalBuilder(
              ...
              builder: (context) => ListView.separated(
                ...
                itemBuilder: (context, index) => builtPostItem(controller.posts[index], context,index),
