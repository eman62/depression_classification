...
class treament extends StatefulWidget {
  ...
  @override
  State<treament> createState() => _treamentState();
}

class _treamentState extends State<treament> {
  @override
              ...
              child: Column(
                children:[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text('How do you help yourself?',
                          style:TextStyle(fontSize:25, color:Colors.blueGrey,fontWeight:FontWeight.bold,),),
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/3997/3997872.png'),
                          fit:BoxFit.fill,width:200, height:200,),
                        SizedBox(height:30,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Ask your doctor s help \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn.iconscout.com/icon/premium/png-64-thumb/high-confidence-3383790-2812143.png'),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/3050/3050525.png'),
                          fit:BoxFit.fill, width:200, height:200,),
                        SizedBox(height:30,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Stay in touch with a specific group \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        Image(image: NetworkImage('https://www.psychosissucks.ca/wp-content/uploads/2022/02/medications.png'),
                        ...
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/706/706195.png'),
                          width:200, height:200,fit:BoxFit.fill,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: '1-food and nutrition\n', style:TextStyle(fontSize:25, color:Colors.black,),),
                        ...
                        Image(image: NetworkImage('https://pngimage.net/wp-content/uploads/2018/06/prohibido-bebidas-alcoholicas-png-2-300x200.png'),
                          width:200, height:200,fit:BoxFit.fill,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: '2.Forbidden drinks\n', style:TextStyle(fontSize:25, color:Colors.black,),),
                        ...
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/512/3094/3094845.png'),
                          width:200, height:200,fit:BoxFit.fill,
                        ),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: '3.sleep\n', style:TextStyle(fontSize:25, color:Colors.black,),),
                              TextSpan(text: 'Sleep disturbances are common in people with of depression, especially patients who are prone to insomnia. And it is hidden'
                                  'Lack of sleep prevents a person from gathering the energy necessary to fightdepression.',
                                  style: TextStyle(fontSize:20, height: 1.5,letterSpacing: 1.0)),],
                          ),
                        ),
                      ],
                    ...
                    child: Column(
                      children: [
                        Text('treatment?',
                          style:TextStyle(fontSize:25, color:Colors.blueGrey,fontWeight:FontWeight.bold,),),
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://t3.ftcdn.net/jpg/04/65/95/26/240_F_465952617_CYZDj9evsT31coU1NIBPadYVUXGPtgJN.jpg'),
                          width:200, height:200,   fit:BoxFit.fill,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Talk to your doctor \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                              TextSpan(text:  'Go to a doctor if treatment methods do not come result, or if your depression is severe. I request For help or call the emergency and accident number at'
                                  ...
                                  '__He has a lot of information about depression\n'
                                  '__He can listen to you\n'
                                  '__Knows you and knows your medical record\n'
                                  ' __He can make sure that there is an organic problem that may be the cause of thisdepression\n'
                                  '__ He can perform some procedures and start therapy sessionsHelp you heal',
                                  style: TextStyle(fontSize:20, height: 1.5,letterSpacing: 1.0)),],
                          ),
                        ),
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/3588/3588472.png'),
                          width:200, height:200,fit:BoxFit.fill,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'TMedical therapies - Speech-based therapies \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/4661/4661703.png'),
                          width:200, height:200,   fit:BoxFit.fill,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Cognitive therapy \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/3588/3588375.png'),
                          fit:BoxFit.fill,width:200, height:200,
                        ),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Behavioral therapy \n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                    ...
                    child: Column(
                      children: [
                        Text('pharmaceutical?',
                          style:TextStyle(fontSize:25, color:Colors.blueGrey,fontWeight:FontWeight.bold,),),
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn.iconscout.com/icon/premium/png-64-thumb/pharmaceutical-engineering-4304079-3571981.png'),width:200, height:200,fit:BoxFit.fill,),
                        SizedBox(height:50,),
                        Text('What are antidepressants?',textAlign: TextAlign.left,
                          style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),

                        ),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/991/991884.png'),
                        ),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text:  'Antidepressants may be effective when treating Depression. When the patient continues to take it according to the doses that'
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/1488/1488096.png'),width:200, height:200,fit:BoxFit.fill),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Will I become addicted?\n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/1207/1207890.png'),
                          width:200,fit:BoxFit.fill, height:200,),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'How do antidepressants work?\n', style:TextStyle(fontSize:25, color:Colors.black,fontWeight:FontWeight.bold),),
                        ...
                        SizedBox(height:30,),
                        Image(image: NetworkImage('https://cdn-icons-png.flaticon.com/128/4228/4228742.png'),width:400, height:200,
                        ),
                        Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                        ...
                        Image(image: NetworkImage('https://kidneydiseaseclinic.net/assets/images/Tricyclic%20Antidepressants.jpg'),
                        ...
                        Image(image: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGiO9oD3hRZ_XdgsNATJHxWBJHejxCDit0xQ&usqp=CAU'),
                          width:500, height:300,fit:BoxFit.fill,
                        ),
                        Text(' \n''Similar to the tricyclic drugs, one must be careful in conflict situations and realize that they cause intestinal troubles in the beginning, in addition to the possibility of diarrhea and vomiting, as well as headache, fatigue and anxiety, but despite that when things reach additional doses,'
                            ...
                            style: TextStyle(fontSize:20, height: 1.5,letterSpacing: 1.7)),
                      ],
                    ),
                    decoration:BoxDecoration(
                        borderRadius:BorderRadius.circular(18),
