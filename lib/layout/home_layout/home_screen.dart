                ...
                return Scaffold(
                  drawer: Drawer(
                    ...
                    ConditionalBuilder(
                      ...
                      builder: (context) =>UserAccountsDrawerHeader(accountName: Text('${AppCubit.get(context).userModel?.name}'),
                      ...
                      fallback: (context) => Center(child: Container()),
                        ...
                        ListTile(
                          ...
                          title: Text('Profile', style: TextStyle(color: defaultColor,fontWeight: FontWeight.w500,fontSize: 20),),
                          onTap:(){
                           // AppCubit.get(context).getUserData();
                            Navigator.push(
                              context,
                        ...
                        ListTile(
                          ...
                          title: Text('Favorite', style: TextStyle(color: defaultColor,fontWeight: FontWeight.w500,fontSize: 20),),
                          onTap:(){
                            Navigator.push(
                              context,
                        ...
                        ListTile(
                          ...
                          title: Text('Feedback', style: TextStyle(color: defaultColor,fontWeight: FontWeight.w500,fontSize: 20),),
                          onTap:(){
                            Navigator.push(
                              context,
                        ...
                        ListTile(
                          ...
                          title: Text('Log Out', style: TextStyle(color: defaultColor,fontWeight: FontWeight.w500,fontSize: 20),),
                          onTap:() {
                  ...
                  appBar: AppBar(
                    title: Text(AppCubit.get(context).name[AppCubit.get(context).currentIndex],style: TextStyle(fontSize:25,fontWeight: FontWeight.bold),),
                    actions: [
